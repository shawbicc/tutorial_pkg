...
if("TRUE" STREQUAL "TRUE")
  set(tutorial_pkg_SOURCE_PREFIX /home/vboxuser/tutorial_ws/src/tutorial_pkg)
  set(tutorial_pkg_DEVEL_PREFIX /home/vboxuser/tutorial_ws/src/tutorial_pkg/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tutorial_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/tutorial_ws/src/tutorial_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vboxuser/tutorial_ws/src/tutorial_pkg/build/devel/lib;/opt/ros/noetic/lib)
